...
import { davide, giulia, laura, marco } from "./mockUsers";
...
export const tasks: Task[] = [
  ...
  {
    title: "Bozza pratica permitting Cliente Gamma",
    code: "OPS-1029",
    status: "Da fare",
    priority: "Media",
    description:
      "Preparare il primo set di verifiche per pratica autorizzativa collegata a nuovo sito.",
    workTime: "0h 00m",
    standbyTime: "0h 00m",
    blockedTime: "0h 00m",
    assignees: [davide, giulia],
    assignedAt: "2026-05-04",
    dueDate: "2026-05-06",
    sectors: ["Permitting", "Area Operation"],
    checklist: [
      {
        id: "CHK-1029-1",
        title: "Verificare documenti urbanistici",
        completed: false,
        assignees: [davide],
      },
      {
        id: "CHK-1029-2",
        title: "Condividere criticità con Capo BU",
        completed: false,
        assignees: [giulia],
      },
    ],
